            ...
            switch (autoCommand[i]) {
                case 1:
                    if ((Math.abs(timeStamp - 1000.0) <= 1e-9) && (!allController[i].anyMovement())) {
                        allController[i].run(true);
                        allController[i].turnRightFast(true);
                    }
                    break;
                case 2:
                    if ((Math.abs(timeStamp - 1000.0) <= 1e-9) && (!allController[i].anyMovement())) {
                        allController[i].run(true);
                        allController[i].turnLeftFast(true);
                    }
                    break;
                case 3:
                    if ((Math.abs(timeStamp - 1000.0) <= 1e-9) && (!allController[i].anyMovement())) {
                        allController[i].walk(true);
                        allController[i].turnRightFast(true);
                    }
                    break;     
                case 4:
                ...
                case 7:
                    if ((Math.abs(timeStamp - 1000.0) <= 1e-9) && (!allController[i].anyMovement())) {
                        allController[i].walkBackFast(true);
                        allController[i].turnRightFast(true);
                    }
                    break;     
                case 8:
